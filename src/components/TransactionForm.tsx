...
export const TransactionForm: React.FC<TransactionFormProps> = ({ isSubmitting }) => {
  ...
  const daysInMonth = useMemo(() => getDaysInMonth(values.year, values.month), [values.year, values.month, getDaysInMonth]);
  ...
  return (
    <Box sx={{ p: 3 }}>
      ...
      <Box sx={{ mb: 4, p: 3, border: '1px solid', borderColor: 'divider', borderRadius: 1 }}>
        <Typography variant="h6" gutterBottom>Date Selection</Typography>
          ...
          <Grid size={{xs: 12, sm: 6, md: 4}}>
            <FormControl fullWidth error={Boolean(touched?.year && errors?.year)}>
              ...
              {touched.year && errors.year && (
                <FormHelperText>{String(errors.year)}</FormHelperText>
              )}
            </FormControl>
          </Grid>
          ...
          <Grid size={{xs: 12, sm: 6, md: 4}}>
            <FormControl fullWidth error={Boolean(touched.month && errors.month)}>
              ...
              {touched.month && errors.month && (
                <FormHelperText>{String(errors.month)}</FormHelperText>
              )}
            </FormControl>
          </Grid>
            ...
            <Grid size={{xs: 12, sm: 6, md: 6}}>
              <FormControl fullWidth error={Boolean(touched.endDay && errors.endDay)}>
                ...
                {touched.endDay && errors.endDay && (
                  <FormHelperText>{errors.endDay}</FormHelperText>
                )}
              </FormControl>
            </Grid>
          )}
